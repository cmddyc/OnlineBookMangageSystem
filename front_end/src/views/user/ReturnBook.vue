    ...
    <el-table class="book-table" :data="returnBookList" v-if="isFind" v-loading="loading" style="width: 100%;">
      ...
      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
          <div class="user-ctrl">
            <el-link type="primary" @click="returnBook(scope.row)">添加书评</el-link>
            <el-link type="primary" @click="returnBook(scope.row)">电子书阅览</el-link>
            <el-link type="danger" @click="returnBook(scope.row)">还书</el-link>
          </div>
        </template>
      </el-table-column>
    </el-table>
    <el-link type="primary">历史借阅记录查询</el-link>
  </div>
</template>
